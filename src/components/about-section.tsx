      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start mb-16">
          ...
          <div className="lg:col-span-8 space-y-6 text-muted-foreground leading-relaxed slide-up">
            <p className="text-lg">
              I build production-ready AI systems that combine <strong className="text-foreground font-semibold">Generative AI, Agentic AI, Retrieval-Augmented Generation (RAG), Deep Learning, Fine-Tuning, and MLOps</strong> to solve real-world engineering problems. My focus is on transforming large language models from research concepts into scalable, reliable applications through robust software engineering, modern AI architectures, and intelligent automation.
            </p>
            <p className="text-base">
              I design and develop end-to-end AI platforms, including multi-agent systems, enterprise knowledge platforms, intelligent ML automation tools, LLM engineering playgrounds, and AI-powered educational applications. My recent projects include <strong className="text-foreground font-semibold">ForgeML</strong>, an agentic machine learning platform that automates the complete ML lifecycle from data ingestion to deployment; <strong className="text-foreground font-semibold">EKIP</strong>, an enterprise knowledge intelligence platform powered by advanced RAG, hybrid retrieval, and multi-agent orchestration; <strong className="text-foreground font-semibold">LLM Quest</strong>, a gamified platform for mastering LLM engineering through interactive challenges and interview-grade assessments; and <strong className="text-foreground font-semibold">DPO Playground</strong>, an interactive platform for exploring Direct Preference Optimization, preference learning, and modern LLM alignment techniques.
            </p>
            <p className="text-base">
              Previously, I developed <strong className="text-foreground font-semibold">NeuroPlan AI</strong>, an AI-powered career intelligence platform, <strong className="text-foreground font-semibold">Agentic Placement RAG</strong>, a multi-agent recruitment knowledge assistant, and <strong className="text-foreground font-semibold">Smart Shelf AI</strong>, a quantum-enhanced intelligent retail management system that combines AI-driven recommendations with quantum-inspired optimization. I also authored <strong className="text-foreground font-semibold">"Smart Shelf AI: A Quantum Computing Powered Book Recommendation System,"</strong> published in the <span className="italic font-semibold text-foreground">International Journal of Creative Research Thoughts (IJCRT)</span>.
            </p>
            <p className="text-base">
              My expertise spans <strong className="text-foreground font-semibold">Python, C++, Java, FastAPI, LangChain, LangGraph, Hugging Face Transformers, PyTorch, TensorFlow, Deep Learning, LoRA, QLoRA, DPO, RAGAS, React, Next.js, TypeScript, Docker, Kubernetes, MLflow, Neo4j, Qdrant, Pinecone, PostgreSQL, Supabase, cloud-native AI infrastructure, and modern LLM engineering frameworks</strong>. I build AI systems with a strong emphasis on scalability, performance, clean architecture, and production readiness, creating software that delivers measurable impact beyond proof-of-concept demonstrations.
            </p>
          </div>
